  ...
  render() {
    return (
      <div className={classes.container}>
        <Profile ppicture="https://media.wired.com/photos/593222b926780e6c04d2a195/master/w_2400,c_limit/Zuck-TA-AP_17145748750763.jpg" username="MarkZucc" status="Playing Minecraft" />
        <span className={classes.sidebarHeading}>Lobbia</span>
